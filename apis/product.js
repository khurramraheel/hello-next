...
export default {
    ...
    addProduct:(args)=>{
        ...
        return axios.post( process.env.NEXT_PUBLIC_MERI_WEBSITE + '/api/products/addProduct', {  
             ...args,
             token:localStorage.getItem('token')
         });
    ...
    getProducts:(args)=>{
       ...
       return axios.post( process.env.NEXT_PUBLIC_MERI_WEBSITE +  '/api/products/getProducts', {  
            ...args,
            token:localStorage.getItem('token')
        });
